...
/**
 * AddCard screen — form sederhana untuk bikin 1 kartu baru.
 *
 * 2 field: front (pertanyaan) dan back (jawaban).
 * Tombol Simpan disabled sampai keduanya tidak empty.
 *
 * Setelah Simpan sukses, [onSaved] dipanggil → caller navigate back ke CardListScreen.
 */
